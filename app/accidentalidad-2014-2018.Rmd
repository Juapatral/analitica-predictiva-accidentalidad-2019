...
En este trabajo se analizó un conjunto de datos relacionados con accidentes de tráfico donde se busca un modelo que se acerque a la condicción actual del fenomeno que presentan los datos reales.

Se evaluaron tres tipos de modelos: la regresión lineal multivariada, regresión lineal generalizada con distribuación Poisson y árbol de decisiones. Después de examinar cuáles factores tenían una influencia fuerte sobre el fenomeno de los accidentes se encontró que un modelo de regresión lineal generalizado de distribución Poisson era el que mostraba tener una predicción más acercaba al fenomeno real.

Se encontró que los factores que más influencian los accidentes de tránsito corresponden a la clase de accidente, día del accidente y un fuerte impacto en determinados días especiales a lo largo del año, como los días festivos, las vacaciones colectivas, entre otros.
...
Se encuentran ciertas situaciones con el modelo y su predicción. Se puede observar que el día mas traumático mostrado por los datos reales es el viernes. Para una ciudad como Medellín es coherente, ya que finaliza jornada laboral, semana de trabajo y la gente opta por salir a divertirse o llegar rapido a sus casas, por lo que el contexto hace que se generen más siniestros de lo normal. En la otra mano, los días más tranquilos son los domingos y lunes por ser inicio de semana, donde la gente está menos cansada y con la rutina apenas comenzando. Estas conclusiones se pueden evidenciar igualmente en el modelo de predicciones para 2019.
