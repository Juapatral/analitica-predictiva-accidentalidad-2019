...
#el Modelo ajustado de Poisson es el que menor error cuadratico muestra( ```{r}ResultadosR2[which(ResultadosR2$MSE==min(ResultadosR2$MSE)),-2]```) para los datos estudiados, por lo que a partir de estas evidencias lo escogemos como el modelo màs conveniente para hacer la predicción
...
se guarda junto alconjunto de datos nuevo para ser visualizado en la aplicacio´pm
```{r}
